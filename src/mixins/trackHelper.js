...
export var getTrackCSS = function(spec) {
  ...
  var style = {
    opacity: 1,
    WebkitTransform: !spec.vertical ? 'translate(' + spec.left + 'px, 0px)' : 'translate(' + spec.left + 'px, 0px)',
    transform: !spec.vertical ? 'translate(' + spec.left + 'px, 0px)' : 'translate(' + spec.left + 'px, 0px)',
    transition: '',
    WebkitTransition: '',
    msTransform: !spec.vertical ? 'translate(' + spec.left + 'px)' : 'translateY(' + spec.left + 'px)',
  };
